...
const TravelComp = ({bg, des, price, day}) => {
  return (
    <div className="flex z-50 flex-col h-[30rem] md:h-[20rem] lg:w-full lg:h-[30rem] md:flex-row lg:flex-col rounded-3xl box_shadow cursor-pointer hover:scale-105 transition-all duration-300">
