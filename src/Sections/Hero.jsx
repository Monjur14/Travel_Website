  ...
  return (
    <div className="contain section_padding w-full h-screen flex flex-col lg:flex-row gap-10 lg:gap-0">
      <div className="space-y-4 xsm:space-y-6 xxl:space-y-10 basis-1/2">
        ...
        <h1 className="font-volkhov text-[2.9rem] xsm:text-[3.3rem] md:text-[5.3rem] lg:text-[5rem] leading-tight font-extrabold xxl:text-[6.5rem]">Travel, <span className="relative z-30">enjoy <img src="Decore1.png" alt="" className="w-96 h-2 absolute bottom-2 left-0 -z-30"/></span> and live a new and full life</h1>
